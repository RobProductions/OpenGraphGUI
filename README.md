...
<img width = "800" src="Documentation~/DocAssets/AllTagsScreenshot.jpg">
...
In ShaderGraph, simply set your *"Custom Editor GUI"* to the named class *"RPOpenGraphGUI"*, and you're all set to start prefixing!
